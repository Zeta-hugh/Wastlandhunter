...
try{
 ...
 await page.waitForFunction(()=>typeof RUSTPORT_VISUAL_VERSION!=='undefined'&&RUSTPORT_GROUND.complete&&RUSTPORT_GROUND.naturalWidth>0);
 ...
 console.log('PASS: Rustport v1 texture loaded, day/dusk rendered, no runtime or asset errors.');
}finally{
 await browser?.close();
