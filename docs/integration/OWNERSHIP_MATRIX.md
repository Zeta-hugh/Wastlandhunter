...
|---|---|---|---|
| `data/schemas/` | Shared Contract / Save / QA | Present, untracked baseline files | Sole contract owner |
| `data/world_state_keys.json` | Shared Contract / Save / QA | Present, untracked | Sole contract owner |
...
| `game/core/save/` | Shared Contract / Save / QA | Present, untracked baseline | Sole Save contract owner until consumer migration |
| `game/core/debug/` | Shared Contract / Save / QA | Present, untracked specification | Specification only unless Integration approves implementation |
...
| `scripts/validation/` | Shared Contract / Save / QA | Present, untracked baseline | Sole shared validator owner |
